...
colour = "g";% RGB,HSV, GRAYSCALE, YCBR, NTSC
...
iterations = 10;
predicted_categories = strings(1500,iterations);
for i = 1:iterations
    switch lower(CLASSIFIER)    
        ...
        % Useful functions: pdist2 (Matlab) and vl_alldist2 (from vlFeat toolbox)
              predicted_categories(:,i) = nearest_neighbor_classify(k,train_image_feats, train_labels, test_image_feats,DISTANCE);
        case 'support vector machine'

            predicted_categories(:,i) = svm_classify(train_image_feats, train_labels, test_image_feats);
    end
end
...
for i = 1:10
    accuracy(i) = create_results_webpage_testing( train_image_paths, ...
                            test_image_paths, ...
                            train_labels, ...
                            test_labels, ...
                            categories, ...
